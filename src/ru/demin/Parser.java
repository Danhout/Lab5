...
public class Parser {
            ...
            throws IllegalArgumentException, IOException
    {
        ...
        return new Trio<Integer, Integer, Integer>(i, trioLong.second, trioLong.third);
    }
            ...
            throws IllegalArgumentException, IOException
    {
        ...
        numberLine = trio.second;
        numberChar = trio.third;

        Pair<Integer, Integer> pair = readCharacter(':', reader, trio.second, trio.third);

        return new Pair<Integer, Integer>(pair.first, pair.second);
    }
            ...
            throws IllegalArgumentException, IOException
    {
        ...
        return new Trio <SpaceMarine, Integer, Integer>(spaceMarine, numberLine, numberChar);
    }
}
